...
The processed Seurat objects are saved together with a report on the analysis that
helps understanding what has been done and where results are saved. 
Additional analyses can be added using the processed Seurat objects. 
